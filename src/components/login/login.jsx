...
import { setUserToken } from "../../redux/user/UserSlice.JSx";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        dispatch(setUserToken(encryptedToken));
      ...
      >
        ...
        <div className="mb-4 relative">
          ...
          <input
            ...
            onChange={handleInputChange}
          />
          <div className="absolute inset-y-9 right-0 bottom-2 pr-3 flex items-center text-sm leading-5">
            {showPassword ? (
              <EyeOff
